	...
	<nav class="navbar-fixed-top" id="navigation">
		<div class="headernavibar01">
			<div class="headernavbar02">
				<div class="phone">
					<img src='<c:url value="/resources/img/phone.png"></c:url>' alt="">
					<span style="font-family: 'Roboto', sans-serif; font-size: 12px; color: white;">080-8282-1253</span>
				</div>
				<ul class="nav__menu">
					<li><a href="#ssintro" id="sintro">세이버소개</a></li>
					<li><img
			...
			<div class="row">
				<div class="col-md-12 center">
					...
					<a class="brand pull-left" href=""> 
						<img src="<c:url value="/resources/img/logo_re.png"/>" alt="LifeSaver" id="logo_mobile" />
					</a>
					<!-- END LOGO -->
					...
					<div class="main__navibar" id="main__navibar">
						<ul id="main-menu" class="collapse navbar-collapse">
							...
							<li><a href="#page-donate" id="donate-move">후원</a></li>
...
<%--    
	...
	<!-- Saver Status -->
	<div class="pages page-work" id="page-status"
	 style="height: 750px;padding-top: 4%;">
        <div class="container" >
           <div id="all-boxes" >
              ...
              <div id="box1">
                 <div id="box1-1">
                    <div id ="text-field-1">
                       <div id ="text1"><span>세이버 인원</span></div>
              ...
              <div id="box2">
                 <div id="box2-1">
                 <div id ="text-field-2">
                       <div id ="text2"><span>심정지 발생</span></div>
              ...
              <div id="box4">
                 <div id="box4-1">
                 <div id ="text-field-4">
                       <div id ="text4"><span>세이버 구조</span></div>
				...
				<nav class="submenu">
					<ul>
						<li><a href="#" class="plugin-filter active"
							data-filter="all" onfocus="blur()">전체</a></li>
						<li><a href="#" class="plugin-filter"
							data-filter="typography"  onfocus="blur()">CPR/AED정보</a></li>
						<li><a href="#" class="plugin-filter"
							data-filter="illustration"  onfocus="blur()">응급의료정보</a></li>
						<li><a href="#" class="plugin-filter" data-filter="branding" onfocus="blur()">법령정보</a>
						</li>
						<li><a href="#" class="plugin-filter"
							data-filter="photography"  onfocus="blur()">기타정보</a></li>
					</ul>
				</nav>
			</header>
			<!-- Sub menu 네비바 | End  -->
			...
			<article>
				...
				<ul class="thumbnails plugin-filter-elements portfolio-items">
					...
					<li class="col-md-4 mix illustration"><a
						href="https://www.e-gen.or.kr/nemc/emergency_medical_services_system.do"
						data-destination="portfolio-items" data-insert="before"> <img
	...
	<div class="pages page-clients" id="page-clients">
		<div class="container">
			...
			<hr />
			<!-- 라이퍼 세이버에 대한 간략 소개-->
			<div class="row" id = "ssintro">
				<div class="col-md-8 col-md-offset-2 center smallFontBy08">
					<p>
						<span style="font-weight: 800; font-size: 20px; color:  #ff4343">라이프 세이버는
							어떤일을 하나요?</span> <br>
	...
	<div class="saver__map" id="page-blog">
		...
		<p align="center">
			<br>
			<button id="btnSend" onclick="getLocation()">신고하기</button>
                 ...
                 for(var j=0; j < keys.length; j++) {
                    ...
                    Hours=Now.getHours(); Minutes=Now.getMinutes(); Seconds=Now.getSeconds();
                         window.open("/lifesaver/mapOk?latitude="+latitude+"&longitude="+longitude+"&Hours="+Hours+"&Minutes="+Minutes
                             +"&Seconds="+Seconds +"&year="+year+"&month="+month+"&date="+date, "newWindow", "width=500, height=1000, scrollbar=no");
                       ...
                       var show_dist = Math.round(dist);
                        ...
                        drawCircleRange(mouseLatLng, 100);
                          ...
                          mpPositions = [myPlace];
                           ...
                           Hours=Now.getHours(); Minutes=Now.getMinutes(); Seconds=Now.getSeconds();
                                window.open("/lifesaver/mapOk?latitude="+latitude+"&longitude="+longitude+"&Hours="+Hours+"&Minutes="+Minutes
                                    +"&Seconds="+Seconds +"&year="+year+"&month="+month+"&date="+date, "newWindow", "width=1000, height=500, scrollbar=no");
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card card-blog">
            <div class="card-img">
             <img src='./resources/img/biglogo.png' alt="" class="img-fluid">
            </div>
            <div class="card-body">
              ...
              <hr />
             	  <p2 class= "nanumstyle" id ="nanumstyle">LifeSavor 6월 2일부터 정상 운영합니다
        ...
        <div class="col-md-4">
          <div class="card card-blog">
            ...
            <div class="card-body">
              ...
              <h3 class="card-title">공지</h3>
              <hr />
              <p2 class= "nanumstyle" id ="nanumstyle">게시판 관련 공지<br /> 
                        <!--  <span id="dots2">...</span><br /> -->
                         <span id="more2">게시판 세부 페이지 제작이 6월 말로 연기되었습니다. <br />
						<!--  <span id="moretext2">		
        ...
        <div class="col-md-4">
          <div class="card card-blog">
            ...
            <div class="card-body">
              ...
              <h3 class="card-title">cpr순서</h3>
              <hr />
                 <p2 class= "nanumstyle" id ="nanumstyle">cpr순서에 대해 알려드립니다 <br />
